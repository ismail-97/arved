...
const EditProduct = () => {
    ...
    const editItem = async (event) => {
        ...
        const authors = []
        Array.from(event.target.authors).map(
            (input) => authors.push(input.value)
        )
        try {
            await dispatch(editProduct(
                {
                    ...
                    authors: event.target.authors.length === undefined ?  authors.concat(event.target.authors.value) : authors,
    ...
    return (
        <div className='product-page '>
            ...
            <Form onSubmit={editItem} className="justify-content-around text-capitalize product-form p-5">
                <Container className="d-flex flex-column align-items-center">
                    <Row className="w-100 justify-content-between">
                        <Col className="col-6">
                            ...
                            <DateInputGroup name="publication_date" id={"publication date"}  defaultValue={product.publication_date}/>
                        ...
                        <Col className="col-6">
                            ...
                            <CitationsInputGroup name="citations" id={"citations"} defaultValue={product.citations} />        
                    ...
                    <Row className="mt-3 mb-0 w-50 d-flex justify-content-center">
                        ...
                        <Form.Group className="mx-3">
                            <Button type="submit" className ="arved-button4" onClick={cancelEditing}>
                                {translate("cancel")}
                            </Button>
                        </Form.Group>
                    </Row>
