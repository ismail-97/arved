...
const AddProduct =  () => {
    ...
    return (
        <div className='product-page'>
            ...
            <Form onSubmit={addItem} className="justify-content-around text-capitalize product-form p-5">
                <Container className="d-flex flex-column align-items-center">
                    ...
                    <Row className="mt-3 mb-0 w-50 d-flex justify-content-center">
                        ...
                        <Form.Group className="mx-3">
                            <Button type="submit" className ="arved-button4" onClick={cancelAdding}>
                                {translate("cancel")}
                            </Button>
                        </Form.Group>
                    </Row>
