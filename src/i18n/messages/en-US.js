...
export default {
    [LOCALES.ENGLISH]: {
        ...
        'document': 'Document',
        'citations': 'Citations',
        'description of the academic product': 'Description of the academic product',
        'add': 'Add',
        'cancel': 'Cancel',
        'URL': 'URL',
        'article': 'article',
        ...
        'unverifiedModalBody': 'You must verify your email for the admin to see your sign up request and approve it.',
        'unverifiedModalFooter': 'Send a new verification link?',
        'pendingModalHeader': 'Your account has not been approved by the admin yet.',
        'pendingModalBody': 'Your sign up request has been sent to the admin for approval.',
        'pendingModalFooter': 'You have to wait for the approval.',
        'successfullRegisterationHeader': 'Verify Your Account',
        'successfullRegisterationBody': 'A verification link has been sent to your email.',
        'successfullRegisterationFooter': 'Check your email for that link to verify your account.', 
        'successfullVerificationHeader': 'Your email has been verified.',
        'successfullVerificationBody': 'Your account has been sent to the admin for approval.',
